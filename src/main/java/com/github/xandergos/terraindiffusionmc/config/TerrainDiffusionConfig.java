...
public final class TerrainDiffusionConfig {
    ...
    private static final int DEFAULT_WORLD_SCALE = 4;
    ...
    public static int worldScale() {
        int v = readInt("world.scale", DEFAULT_WORLD_SCALE);
        if (v < 1 || v > 4) {
            System.err.println("Invalid world.scale: " + v + " (must be 1-4), using default " + DEFAULT_WORLD_SCALE);
